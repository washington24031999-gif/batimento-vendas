...
if arquivo_ativacao and arquivo_protocolos:
    try:
        ...
        if df_ativ is not None and df_prot is not None:
            ...
            # Identificação de colunas de vínculo
            ...
            # Regra de Segurança: Vendedor 1 assume se Responsável for nulo
            ...
            with pd.ExcelWriter(output, engine='openpyxl') as writer:
                ...
                # Validação de Duplicados (Contrato e Nome)
                max_row = ws.max_row
                for col_let in ['B', 'G']:
            ...
            st.success("✅ **Relatório Gerado com Sucesso!** O ficheiro Netmania está pronto para download.")
...
with t1:
    ...
    st.info("Tratamento automático (exclui cancelados).")
with t2:
